                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="abt-text">
                                ...
                                <p>Etiam vulputate ut augue vel sodales. In sollicitudin neque et massa porttitor vestibulum ac vel nisi. Vestibulum placerat eget dolor sit amet posuere. In ut dolor aliquet, aliquet sapien sed, interdum velit. Nam eu molestie
                                    lorem.
                                </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-latest-news">
                                <a href="single-news.html">
                                    <div class="book-pic">
                                        <img style="height:200px; display: block; margin-left: auto; margin-right: auto;" src="assets/img/books/origin-of-others.jpeg" alt="The Origin of Others By Toni Morrison">
                                    </div>
                                </a>
                                <div class="news-text-box">
                                    <h3><a href="single-news.html">The Origin of Others</a></h3>
                                    <p class="blog-meta">
                                        <span class="author"><i class="fas fa-user"></i>Toni Morrison</span>
                                        <span class="date"><i class="fas fa-calendar"></i> Winter 2021</span>
                                    </p>
                                    <p class="excerpt">BRIEF INTRO TO BOOK</p>
                                    <a href="single-news.html" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                            <div class="single-latest-news">
                                <a href="single-news.html">
                                    <div class="book-pic">
                                        <img class="book-pic" src="assets/img/books/black-brown-bruised.jpeg" alt="Black, Brown, Bruised By Ebony Omotola McGee">
                                    </div>
                                </a>
                                <div class="news-text-box">
                                    <h3><a href="single-news.html">Black, Brown, Bruised</a></h3>
                                    <p class="blog-meta">
                                        <span class="author"><i class="fas fa-user"></i>Ebony Omotola McGee</span>
                                        <span class="date"><i class="fas fa-calendar"></i>Spring 2021</span>
                                    </p>
                                    <p class="excerpt">INTRO TO Black, Brown, Bruised</p>
                                    <a href="single-news.html" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
